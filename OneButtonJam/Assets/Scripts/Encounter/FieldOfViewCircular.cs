...
public class FieldOfViewCircular : MonoBehaviour
{
    //static public FieldOfView Instance;
    public float viewRadius;
    [Range(0, 360)]
    public float viewAngle;

    [Range(0, 360)]
    public static float fovRotation;
    ...
    void Start()
    {
        ...
        //StartCoroutine(RotateCone());
        StartCoroutine("FindTargetsWithDelay", .2f);
    }

    //private IEnumerator RotateCone()
    //{
    //    while (true)
    //    {
